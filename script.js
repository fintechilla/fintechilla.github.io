$(document).ready(function() {
  ...
  var apiRoot = 'https://desolate-brook-16006.herokuapp.com/v1/task/';
  ...
  function handleTaskUpdateRequest() {
    ...
    //println("In Update taskId: " + taskId);
    $.ajax({
      url: requestUrl,
      method: "PUT",
      processData: false,
  ...
  function handleTaskDeleteRequest() {
    ...
    //println("In DELETE taskId: " + taskId ); "taskId=" + taskId
    $.ajax({
      url: requestUrl + '?' + $.param({taskId: taskId}),
      method: "DELETE",
      success: function() {
